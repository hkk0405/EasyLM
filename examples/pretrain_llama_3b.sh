...
#export LIBTPU_INIT_ARGS='--jax_enable_async_collective_offload=true --xla_jf_spmd_threshold_for_windowed_einsum_mib=0 --xla_tpu_spmd_threshold_for_allgather_cse=10000 --xla_tpu_spmd_rewrite_einsum_with_reshape=true --xla_enable_async_all_gather=true --xla_tpu_enable_latency_hiding_scheduler=true TPU_MEGACORE=MEGACORE_DENSE'
...
python -m EasyLM.models.llama.llama_train \
    ...
    --log_freq=50 \
    --save_model_freq=0 \
    --save_milestone_freq=250000 \
    --load_llama_config='small' \
    --update_llama_config='' \
    --load_dataset_state='' \
    --load_checkpoint='' \
    --tokenizer.vocab_file="$HOME/.cache/huggingface/hub/models--openlm-research--open_llama_3b/blobs/ab1b681ec7fc02fed5edd3026687d7a692a918c4dd8e150ca2e3994a6229843b" \
    ...
    --logger.output_dir="$HOME/checkpoint/" \
